        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground max-w-xs">
              Creating immersive digital experiences with cutting-edge technologies and creative vision.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="rounded-full bg-background p-2 shadow-sm ring-1 ring-border hover:bg-accent"
